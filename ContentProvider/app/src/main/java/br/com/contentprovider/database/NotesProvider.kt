...
import br.com.contentprovider.database.NotesDatabaseHelper.Companion.TABLE_NOTES
...
class NotesProvider : ContentProvider() {
    ...
    override fun query(
        ...
        return when{
            ...
            mUriMatcher.match(uri) == NOTES_BY_ID -> {
                ...
                throw  UnsupportedSchemeException("Uri não implemetada")
            }
        }
    }
    ...
    companion object{
        const val AUTHORITY = "br.com.contentprovider.provider"
